...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('branches/manage', 'View All Branches', array("class" => "button alt"));
        echo anchor('branches/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="card">
    ...
    <div class="card-body">
        <div class="record-details">
            ...
            <div class="row">
                <div>Branch Type</div>
                <div><?= isset($branchtypes_id) ? out($branchtypes_name) : 'None' ?></div>
            </div>
            <div class="row">
                <div>Parent Group</div>
                <div><?= isset($parent_branch_name) ? out($parent_branch_name) : 'None' ?></div>
            </div>
        </div>
    </div>
</div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('branches/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Branch record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
