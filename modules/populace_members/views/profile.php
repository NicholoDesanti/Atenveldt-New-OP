...
<div class="container my-5">
 <div class="row p-4 align-items-center rounded-3 border border-light-subtle shadow-lg">
      ...
      <div class="col-lg-4 p-3 shadow-lg">
          <img class="img img-fluid" src="https://www.atenveldt.org/wp-content/uploads/2020/10/rosa-duvanova-e1715234374146.jpg" alt="" width="720">
      </div>
    </div>
</div>
<div class="container">
        <div class="row mt-lg-5">
            ...
            <div class="row g-0 border border-light-subtle rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 bg-light position-relative">
                ...
                <img class="img img-fluid" src="https://op.atenveldt.org/assets/img/PersonalArmsImages/Rosa%20Duvanova%20doch%20Sychevna%202.1.png" alt="" width="150">
                </div>
            </div>
            </div>
            <div class="col-md-6">
            <div class="row g-0 border border-light-subtle rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 bg-light position-relative">
                ...
                <p class="card-text mb-auto"><span class="fst-italic">Not specified</span>
                    </p><p class="card-text mb-auto"><?php echo htmlspecialchars($badge_1); ?></p>
                    <button type="button" class="btn btn-secondary my-2 px-4" data-bs-toggle="modal" data-bs-target="#badgeModal">See all</button>
                </div>
                <div class="col-auto d-none p-3 d-lg-block">
                <img class="img img-fluid" src="https://www.atenveldt.org/wp-content/uploads/2020/11/kingdom-populace-device-1.png" alt="" width="150">
                </div>
            </div>
        </div>        
    </div>   
