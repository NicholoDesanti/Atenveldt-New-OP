<ul>
    <li><?= anchor('branches/manage', '<i class="fa fa-bank"></i> Branches') ?></li>
    <li><?= anchor('crowns/manage', '<i class="fa fa-sun-o"></i> Crowns') ?></li>
    <li><?= anchor('awards/manage', '<i class="fa fa-certificate"></i> Awards') ?></li>
